...
class EditAddressSheet extends StatefulWidget{
  ...
  EditAddressSheet({required this.address});
...
class _EditAddressSheet extends State<EditAddressSheet>{
  ...
  @override
  void initState() {
    addressController.addressEditeCon.text=widget.address.title??"";
    addressController.cityEditeCon.text=widget.address.address?.city??"";
    addressController.stateEditeCon.text=widget.address.address?.state??"";
    addressController.zipEditeCon.text=widget.address.address?.zip??"";
    addressController.streetEditeCon.text=widget.address.address?.streetAddress??"";
    if(widget.address.default1==0){
            ...
            children: [
              ...
              IconButton(
                  ...
                  onPressed:(){
                    ...
                    // addressController.addressEditeCon.clear();
                    // addressController.countryEditeCon.clear();
                    // addressController.cityEditeCon.clear();
            ...
            child: TextButton(
              ...
              onPressed: () {
                if(_formKey.currentState!.validate()){
                  addressController.editAddress(context, widget.address.id!);
                }
              },
  ...
  Widget addAddress (){
    return TextFormField(
      ...
      controller: addressController.addressEditeCon,
      validator: (value) {
  ...
  Widget countryText (){
    return TextFormField(
      autovalidateMode:AutovalidateMode.onUserInteraction ,
      controller: addressController.countryEditeCon,
      validator: (value) {
        if (value == null || value.isEmpty) {
  ...
  Widget cityText (){
    return TextFormField(
      autovalidateMode:AutovalidateMode.onUserInteraction ,
      controller: addressController.cityEditeCon,
      validator: (value) {
        if (value == null || value.isEmpty) {
  ...
  Widget stateText (){
    return TextFormField(
      autovalidateMode:AutovalidateMode.onUserInteraction ,
      controller: addressController.stateEditeCon,
      validator: (value) {
        if (value == null || value.isEmpty) {
  ...
  Widget zipCodeText (){
    return TextFormField(
      autovalidateMode:AutovalidateMode.onUserInteraction ,
      controller: addressController.zipEditeCon,
      validator: (value) {
        if (value == null || value.isEmpty) {
  ...
  Widget streetText (){
    return TextFormField(
      autovalidateMode:AutovalidateMode.onUserInteraction ,
      controller: addressController.streetEditeCon,
      validator: (value) {
        if (value == null || value.isEmpty) {
